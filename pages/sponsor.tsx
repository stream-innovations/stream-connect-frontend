        ...
        <Flex pos="relative" gap="6.25rem">
          <Flex zIndex={2} gap="1.25rem" flexFlow="column">
            ...
            <Text color="gray.500" fontSize="1.5rem" fontWeight={400}>
              StreamConnect helps Solana founders save time and outsource all
        ...
        <Flex align="center" justify="end" wrap="wrap" gap="1.25rem" w="100%">
          <Flex flex="1" gap="1.875rem" minW="25rem" flexFlow="column">
            ...
            <Text
              ...
              fontWeight={400}
            >
              Have critical work your team needs completed? StreamConnect will
    ...
    <>
      ...
      >
        ...
        <Flex
          ...
          fontWeight="400"
        >
          <Link href="https://connect.streamprotocol.net/dashboard/company/findtalent">
            Directory
          </Link>
          <Link href="https://connect.streamprotocol.net/bounties">Bounties</Link>
